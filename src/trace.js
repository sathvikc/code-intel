...
export function traceStorage(projectRoots, backend, key, opts = {}) {
  ...
  const result = webStorage.analyzeProjects(projectRoots, { exclude: opts.exclude });
...
export function traceEvent(projectRoots, channel, opts = {}) {
  const projects = projectDescriptors(projectRoots);
  const result = events.analyzeProjects(projectRoots, { exclude: opts.exclude });
...
export function traceGlobal(projectRoots, name, opts = {}) {
  const projects = projectDescriptors(projectRoots);
  const result = globals.analyzeProjects(projectRoots, { exclude: opts.exclude });
